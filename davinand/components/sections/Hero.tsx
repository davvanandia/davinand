  ...
  return (
    <section id="about" className="space-y-6 pt-4 scroll-mt-20">
      ...
      <div className="space-y-3">
        ...
        <p className="text-lg md:text-xl text-zinc-700 dark:text-zinc-300 font-normal leading-relaxed">
          {hero.headline}{" "}
      ...
      <div className="flex flex-wrap items-center gap-2 pt-1">
        {hero.tags.map((tag, i) => (
          <span key={tag} className="flex items-center gap-2">
            ...
            <span className="px-3 py-1 text-xs font-mono rounded bg-zinc-100 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 text-zinc-800 dark:text-zinc-200">
              {tag}
            </span>
          </span>
        ))}
      ...
      <p className="text-zinc-700 dark:text-zinc-300 max-w-2xl leading-relaxed text-sm md:text-base">
        {hero.bio}
      </p>
